    ...
    return (
        <AlertDialog>
            ...
            <AlertDialogContent className='bg-slate-800 px-2 border-0 rounded-lg flex flex-col justify-center items-center'>
                ...
                <p className='w-5/6 text-center text-white bg-gradient-to-b from-slate-600 to-slate-700 rounded-lg py-2 font-semibold'>For every weekly referral, you get 10% Coin Increment up to 30 referrals</p>
                ...
                <p className='text-white font-semibold text-center bg-gradient-to-b from-slate-600 to-slate-700 px-4 py-1 rounded-lg'>10% x {weekly} Weekly Referrals = {10 * weekly}%</p>
