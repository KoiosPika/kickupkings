...
const ShopPage = () => {
    ...
    return (
        <section className='w-full h-screen'>
            ...
            <div className='w-full ml-auto mb-auto p-2 flex flex-row items-center gap-2'>
                <div className='w-1/2 bg-white flex flex-col justify-center items-center rounded-lg h-[53px] sm:h-[75px] gap-[3px]'>
                    <p className='font-bold text-black text-[16px] sm:text-[22px]'>Points: 2.4k / 5k</p>
                ...
                <div className='w-1/2 bg-white flex flex-col justify-center items-center rounded-lg h-[53px] sm:h-[75px]'>
                    <p className='font-bold text-black text-[16px] sm:text-[22px]'>Team Overall: 3.4</p>
            ...
            <div className='w-full flex flex-col justify-center items-center my-2'>
                ...
                <div className='w-11/12 bg-white flex flex-row items-center justify-evenly px-1 py-1 rounded-lg my-2'>
                    {['Defense', 'Midfield', 'Forward', 'Staff'].map((type) => (
                        <p
                            key={type}
                            className={`w-1/4 rounded-md text-center text-[12.5px] sm:text-[24px] font-bold py-[2px] sm:py-[7px] cursor-pointer text-black ${selectedType === type ? 'bg-[#09C609] text-white' : ''
                                }`}
                    ...
                    <div className='grid grid-cols-2 w-full gap-2 sm:gap-3'>
                        {positions
                            ...
                            .map((position: any, index: number) => (
                                <div key={index} className='flex flex-col justify-center items-center w-full bg-white rounded-xl h-[100px] sm:h-[150px]'>
                                    <div className='flex flex-row items-center w-full p-2 gap-1'>
                                        ...
                                        <div className='flex flex-col justify-center items-center w-3/4 sm:w-2/3 gap-1'>
                                            <p className='text-[11px] sm:text-[18.5px] font-bold text-black'>{position.label}</p>
                                    ...
                                    <div className='border-t-2 border-slate-300 w-full py-1 sm:py-2'>
                                        <p className='font-semibold text-black text-center text-[14px] sm:text-[25px]'>Level 0 {`->`} Level 1</p>
                                    </div>
                                </div>))}
                    </div>
                </ScrollArea>
